                ...
                <div className="row mt-5">
                    <div className="col-6 p-3">
                        ...
                        <Slider {...settings} className="slider text-center">
                            <div class="card  p-3">
                                <img src={person1} class="card-img-top w-50 mx-auto pt-5 rounded-circle" alt="..." />
                                <div class="card-body pt-5">
                                    <h3>Jhon Doe</h3>
                                    <p class="card-p">“A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.”</p>
                                </div>
                            </div>
                            <div class="card p-3">
                                <img src={person2} class="card-img-top w-50 mx-auto pt-5 rounded-circle" alt="..." />
                                <div class="card-body pt-5">
                                    <h3>Tony Stark</h3>
                            ...
                            <div class="card p-3">
                                <img src={person3} class="card-img-top w-50 mx-auto pt-5 rounded-circle" alt="..." />
                                <div class="card-body pt-5">
                                    <h3>Rob Smith</h3>
                                    <h6>Manager</h6>
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button class="accordion-button collapsed fs-3 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                            What should I consider for travelling?
                                        </button>
                                    </h2>
                                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body fs-5">Try to see the facilities before booking a resort, or plan a safe stay before leaving your home.Make sure you keep id cards for each member going with you, in case of emergency it may be required.If going by road, check weather before leaving, and make necessary arrangements.</div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingTwo">
                                        <button class="accordion-button collapsed fs-3 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-headingThree">
                                        <button class="accordion-button collapsed fs-3 fw-bolder" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
